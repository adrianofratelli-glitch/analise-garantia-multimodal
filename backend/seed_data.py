...
CHAMADOS_SEED = [
    # ---------- CADEIRA ----------
    {"numero_chamado": "CHM-2026-0001", "numero_pedido": "MM-88471", "categoria": "cadeira",
    ...
    {"numero_chamado": "CHM-2026-0002", "numero_pedido": "MM-88472", "categoria": "cadeira",
     "produto": {"sku": "CAD-OFF-PRO", "nome": "Cadeira Office Pro"},
    ...
    {"numero_chamado": "CHM-2026-0003", "numero_pedido": "MM-88473", "categoria": "cadeira",
    ...
    {"numero_chamado": "CHM-2026-0004", "numero_pedido": "MM-88474", "categoria": "cadeira",
     "produto": {"sku": "CAD-GAMER-X", "nome": "Cadeira Gamer X"},
     "checklist": ["mancha"],
     "descricao_cliente": "Mancha escura de cafe no encosto, aconteceu em casa.",
     "imagem_arquivo": "cad_04.jpg", "resolucao_final": "mau_uso"},

    {"numero_chamado": "CHM-2026-0005", "numero_pedido": "MM-88475", "categoria": "cadeira",
     "produto": {"sku": "CAD-OFF-PRO", "nome": "Cadeira Office Pro"},
    ...
    # ---------- COLCHÃO ----------
    {"numero_chamado": "CHM-2026-0006", "numero_pedido": "MM-88476", "categoria": "colchao",
    ...
    {"numero_chamado": "CHM-2026-0007", "numero_pedido": "MM-88477", "categoria": "colchao",
     "produto": {"sku": "COL-MOLAS-Q", "nome": "Colchao Molas Ensacadas Queen"},
     "checklist": ["mancha"],
    ...
    {"numero_chamado": "CHM-2026-0008", "numero_pedido": "MM-88478", "categoria": "colchao",
    ...
    {"numero_chamado": "CHM-2026-0009", "numero_pedido": "MM-88479", "categoria": "colchao",
     "produto": {"sku": "COL-MOLAS-Q", "nome": "Colchao Molas Ensacadas Queen"},
    ...
    {"numero_chamado": "CHM-2026-0010", "numero_pedido": "MM-88480", "categoria": "colchao",
     "produto": {"sku": "COL-ESPUMA-S", "nome": "Colchao Espuma Solteiro"},
    ...
    # ---------- GUARDA-ROUPA ----------
    {"numero_chamado": "CHM-2026-0011", "numero_pedido": "MM-88481", "categoria": "guarda_roupa",
    ...
    {"numero_chamado": "CHM-2026-0012", "numero_pedido": "MM-88482", "categoria": "guarda_roupa",
     "produto": {"sku": "GR-6PORTAS", "nome": "Guarda-Roupa 6 Portas"},
     "checklist": ["arranhado"],
    ...
    {"numero_chamado": "CHM-2026-0013", "numero_pedido": "MM-88483", "categoria": "guarda_roupa",
    ...
    {"numero_chamado": "CHM-2026-0014", "numero_pedido": "MM-88484", "categoria": "guarda_roupa",
     "produto": {"sku": "GR-3PORTAS", "nome": "Guarda-Roupa 3 Portas"},
    ...
    {"numero_chamado": "CHM-2026-0015", "numero_pedido": "MM-88485", "categoria": "guarda_roupa",
     "produto": {"sku": "GR-6PORTAS", "nome": "Guarda-Roupa 6 Portas"},
